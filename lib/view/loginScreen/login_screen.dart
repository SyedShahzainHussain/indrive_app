...
import 'package:user_uber_app/widget/text_input_field.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void saveUserNow() async {
    ...
    if (firebaseUser != null) {
      ...
      driversRef.child(firebaseUser.uid).once().then((user) {
        final snap = user.snapshot;
        if (snap.value != null) {
